...
<head>
    ...
    <title>Bai tap thoi gian 2</title>
...
<body>
    ...
    <form action="#" method="post" id="mainForm" name="mainForm">
        <p>Start: <input type="text" name="date-start" id="date-start"
                value="<?php echo $dateStart; ?>"></p>
        <p>End: <input type="text" name="date-end" id="date-end" value="<?php echo $dateEnd; ?>">
        </p>
